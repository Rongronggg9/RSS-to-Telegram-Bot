...
if env.TELEGRAPH_TOKEN:
    telegraph_api = telegraph.Telegraph(access_token=env.TELEGRAPH_TOKEN)
    try:
        telegraph_api.get_account_info()
    except telegraph.TelegraphException as e:
        logger.warning('Telegraph API token may be invalid, create one instead.')
        telegraph_api.create_account(short_name='RSStT', author_name='Generated by% RSStT',
